...
var through = require('through2')
  ...
  , extractParameters = require('./extract-parameters')
  , gutil = require('gulp-util')
  , rawBody = require('raw-body')
  , wrapTex = require('../transforms/default')
  , path = require('path')
